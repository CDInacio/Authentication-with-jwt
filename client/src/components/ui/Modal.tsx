      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="data-[state=open]:animate-contentShow fixed top-[50%] left-[50%] max-h-[85vh] w-[90vw] max-w-[450px] translate-x-[-50%] translate-y-[-50%] rounded-[6px] bg-dark p-[25px] shadow-[hsl(206_22%_7%_/_35%)_0px_10px_38px_-10px,_hsl(206_22%_7%_/_20%)_0px_10px_20px_-15px] focus:outline-none">
          ...
          <fieldset className="mb-[15px] flex flex-col gap-5">
            <label className="text-white w-[90px]  text-[15px]" htmlFor="name">
              Título
            </label>
            <input
              className="text-primary-500 duration-300 bg-dark shadow-neutral-500 focus:shadow-purlpe inline-flex py-[10px] w-full flex-1 items-center justify-center rounded-[4px] px-[10px] text-[15px] leading-none shadow-[0_0_0_1px] outline-none focus:shadow-[0_0_0_2px]"
              id="name"
          ...
          <fieldset className="mb-[15px] flex flex-col  gap-5">
            <label
              className="text-white w-[90px]   text-[15px]"
              htmlFor="username"
            >
              Descrição
            </label>
            <textarea
              rows={10}
              className="text-primary-500 duration-300 bg-dark shadow-neutral-500 focus:shadow-purlpe inline-flex h-[35px] w-full flex-1 items-center justify-center rounded-[4px] px-[10px] text-[15px] leading-none shadow-[0_0_0_1px] outline-none focus:shadow-[0_0_0_2px]"
              id="username"
